...
export function FirstSection() {
  return (
    <div className="relative">
      {/* Logo */}
      <div className="relative z-10 flex items-center justify-between px-6 py-8 md:px-[39px] md:py-[61px] lg:px-[165px] lg:py-[62px]">
      ...
      {/* Headline & subtitle */}
      <div className="relative z-10 px-6 pb-16 pt-4 md:px-10 lg:px-[165px] lg:pt-[100px]">
        <h1 className="text-h1 max-w-[327px] md:max-w-[520px] lg:max-w-[1015px]">
